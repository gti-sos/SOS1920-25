		...
		db.find({"country": country, "year": year},(error, countries_for_equality_stats1)=>{
			if(countries_for_equality_stats1.length != 0){	
				...
				res.sendStatus(409);
		  			 ...
		  			 || !newcountries_for_equality_stats.var || Object.keys(newcountries_for_equality_stats).length != 5
					){
				
				console.log("El número de campos no es 5 o no estan bien escritos");
				res.sendStatus(400);
			}else{
