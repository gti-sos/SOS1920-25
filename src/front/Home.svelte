...
<body>
	...
	<b style="font-size:150%;">Team</b>
		<ul>
			<li><a href = "https://github.com/juaarcgon">Juan Manuel Arcos Gonzalez</a></li>
			<li><a href = "https://github.com/adriator77">Adrian Escudero Barra</a></li>
			<li><a href = "https://github.com/LagForever">Alejandro Mena Claro</a></li>
		</ul>
	<b style ="font-size:150%">Project description:</b>
		<p>We are going to analyse</p>
		<ul>
  			<li>happiness rate</li>
  			<li>competitiveness</li>
  			<li>equality</li>
		</ul>
		<b style ="font-size:150%">Repository:</b><a href = "https://github.com/gti-sos/SOS1920-25">gti-sos/SOS1920-25</a>
		<br><b style ="font-size:150%"> URL:</b><a href = "https://sos1920-25.herokuapp.com/" >https://sos1920-25.herokuapp.com/git </a>
		<br><b style ="font-size:150%">APIs:</b>
		<ul>
